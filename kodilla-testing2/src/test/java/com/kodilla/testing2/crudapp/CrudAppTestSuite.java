...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://kargoolek.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("karol933");
    ...
    private boolean shouldDeleteTestTaskFromCrudApp(String taskName) throws InterruptedException {
        while (!driver.findElement(By.xpath("//select[1]")).isDisplayed());
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        ...
        assertTrue(shouldDeleteTestTaskFromCrudApp(taskName));
    }
}