...
public class ExtraFoodShopProduct implements Product {
    ...
    public ExtraFoodShopProduct(final long itemID, final double itemQuantity) {
        this.itemID = itemID;
        this.itemQuantity = itemQuantity;
    }

    public ExtraFoodShopProduct(final long itemID, final String itemName, final boolean isAvailableNow, final double itemQuantity, final String itemQuantityType, final BigDecimal prize) {
        this.itemID = itemID;
