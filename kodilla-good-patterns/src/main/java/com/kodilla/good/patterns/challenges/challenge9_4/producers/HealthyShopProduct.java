...
public class HealthyShopProduct implements Product {
    ...
    public HealthyShopProduct(final long itemID, final double itemQuantity) {
        this.itemID = itemID;
        this.itemQuantity = itemQuantity;
    }

    public HealthyShopProduct(final long itemID, final String itemName, final boolean isAvailableNow, final double itemQuantity, final int callories, final String itemQuantityType, final BigDecimal prize) {
        this.itemID = itemID;
